...
```{r }
#import data
LK952_metadata <- read_excel(here::here("Figure_5DEF", "Corynebacterium_ABON_Results.xlsx"), 
    sheet = "Sample BGCome Overview")
LK952_results <- read_excel(here::here("Figure_5DEF", "Corynebacterium_ABON_Results.xlsx"), 
...
```{r }
#import data
LK960_metadata <- read_excel(here::here("Figure_5DEF", "Kocuria_ABON_Results.xlsx"), 
    sheet = "Sample BGCome Overview")
LK960_results <- read_excel(here::here("Figure_5DEF", "Kocuria_ABON_Results.xlsx"), 
    sheet = "Similarity to Target Genomes")
...
```{r }
#import data
LK1337_metadata <- read_excel(here::here("Figure_5DEF", "Brevibacterium_ABON_Results.xlsx"), 
    sheet = "Sample BGCome Overview")
LK1337_results <- read_excel(here::here("Figure_5DEF", "Brevibacterium_ABON_Results.xlsx"), 
    sheet = "Similarity to Target Genomes")
...
```{r }
#import data
LK1188_metadata <- read_excel(here::here("Figure_5DEF", "Aestuariimicrobium_ABON_Results.xlsx"), 
    sheet = "Sample BGCome Overview")
LK1188_results <- read_excel(here::here("Figure_5DEF", "Aestuariimicrobium_ABON_Results.xlsx"), 
    sheet = "Similarity to Target Genomes")
