...
library(dplyr)
data = read.csv("/Users/unguyen2/Documents/GitHub/Kalan_Lab/scripts/ssandstrom/skin_bioassay_paper_files/fig_3/bioassay_data_new_wide_novel_species.csv")
data = read.csv("/Users/unguyen2/Documents/GitHub/Kalan_Lab/scripts/ssandstrom/skin_bioassay_paper_files/fig_3/bioassay_data_new_wide_novel_species_080423.csv")
...
colnames(heatmap)[1] = "LK1000" 
colnames(heatmap)[2] = "LK1337"
colnames(heatmap)[3] = "LK960"
theatmap = as.data.frame(t(heatmap))
colnames(theatmap)=paths
theatmap <- theatmap[, paths1] #used this code
theatmap <- theatmap %>% select(all_of(paths1)) #this code also works
